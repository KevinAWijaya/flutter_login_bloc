...
class VButtonIcon extends StatelessWidget {
  ...
  const VButtonIcon({
    ...
    required this.onTap,
    this.selectedColor = VColor.secondary,
    this.selectedIconColor = VColor.onSecondary,
    this.unselectedColor = Colors.transparent,
    this.unselectedIconColor = VColor.secondary,
    this.borderColor = VColor.secondary,
